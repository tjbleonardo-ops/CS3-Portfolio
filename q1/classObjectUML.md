...
|---|---|---|
| Task Name | String | This property of the object is the name of the task. |
| Deadline | Integer | This integer property of the object is the deadline of that specific task. |
| Completed | Boolean | This property determines whether or not the task is done or not. This property is set to false automatically |
| Type of Task | String | This property |
## Methods
| Method | Description |
|---|---|| | |
